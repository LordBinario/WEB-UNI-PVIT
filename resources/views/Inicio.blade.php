...
@section('Contenido')
        ...
        <div class="col-12 px-0">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="{{asset('Imagenes/Inicio/SlideShow Principal/Imagen1.svg')}}" class="d-block w-100" alt="Imagen 1">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('Imagenes/Inicio/SlideShow Principal/Imagen2.svg')}}" class="d-block w-100" alt="Imagen 2">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('Imagenes/Inicio/SlideShow Principal/Imagen3.svg')}}" class="d-block w-100" alt="Imagen 3">
                    </div>
                </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-6 col-md-3 col-lg-3 align-self-center wow fadeIn">
            ...
            que tendrá esa url--}}
            <a href="{{url('/Nosotros', ['Departamento' => 'AE'])}}">
                <img src="{{asset('Imagenes/Inicio/logos/LogoAE.svg')}}" alt="Logo de Atención Empresarial" class="img-fluid">
            </a>
        </div>
        <div class="col-6 col-md-3 col-lg-3 align-self-center wow fadeIn">
            <a href="{{url('/Nosotros', ['Departamento' => 'BIOMASA'])}}">
                <img src="{{asset('Imagenes/Inicio/logos/LogoBIOMASA.svg')}}" alt="Logo de BIOMASA" class="img-fluid">
            </a>
        </div>
        <div class="col-6 col-md-3 col-lg-3 text-center mt-3 mt-md-0 wow fadeIn">
            <a href="{{url('/Nosotros', ['Departamento' => 'EAUT'])}}">
                <img src="{{asset('Imagenes/Inicio/logos/LogoEAUT.svg')}}" alt="Logo de EAUT" class="img-fluid w-75">
            </a>
        </div>
    </div>
    ...
    <div class="row mt-5 py-4 bg-gris">
        <div class="col-12 text-center">
            ...
            <div class="row justify-content-center mt-2 mb-3">
                <a href="{{url('/Servicios', ['Departamento' => 'AE'])}}" class="col-12 col-sm-9 col-md-5 col-lg-5">
                    <img src="{{asset('Imagenes/Inicio/Curso1.svg')}}" alt="Curso 1" class="img-fluid">
                </a>
                <a href="{{url('/Servicios', ['Departamento' => 'AE'])}}" class="col-12 col-sm-9 col-md-5 col-lg-5 mt-3 mt-md-0">
                    <img src="{{asset('Imagenes/Inicio/Curso2.svg')}}" alt="Curso 2" class="img-fluid">
                </a>
            </div>
                                ...
                                <div class="col-12 col-md-3 align-self-start">
                                    <div class="row justify-content-center">
                                        <div class="col-8 col-sm-3 col-md-12">
                                            <img src="{{asset('Imagenes/Inicio/logos/LogoCONICYT.png')}}" alt="Logo de FAO" class="img-fluid w-100">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-3 align-self-start">
                                    <div class="row justify-content-center">
                                        <div class="col-8 col-sm-3 col-md-12">
                                            <img src="{{asset('Imagenes/Inicio/logos/LogoFAO.svg')}}" alt="Logo de FAO" class="img-fluid w-100">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
    ...
    <div class="row mt-4">
        <div class="col-12 text-center">
            ...
            <div class="NoExiste">
                ...
                <div>
                    <img src="{{asset('Imagenes/Inicio/logos/LogoINTA.svg')}}" alt="Logo del INTA" class="img-fluid w-100">
                </div>
                <div>
                    <img src="{{asset('Imagenes/Inicio/logos/LogoIPSA.svg')}}" alt="Logo del IPSA" class="img-fluid w-100">
                </div>
                <div>
                    <img src="{{asset('Imagenes/Inicio/logos/LogoCNU.svg')}}" alt="Logo del CNU" class="img-fluid w-100">
                </div>
                <div>
                    <img src="{{asset('Imagenes/Inicio/logos/LogoMEFCCA.svg')}}" alt="Logo del MEFCCA" class="img-fluid w-100">
                </div>
                <div>
                    <img src="{{asset('/Imagenes/Inicio/logos/LogoMINSA.svg')}}" alt="Logo del MINSA" class="img-fluid w-100">
                </div>
                <div>
                    <img src="{{asset('Imagenes/Inicio/logos/LogoFISE.svg')}}" alt="Logo del FISE" class="img-fluid w-100">
                </div>
            </div>
        </div>
    </div>
