...
<?php $__env->startSection('Contenido'); ?>
    ...
    <?php echo $__env->make('Vista parcial.Nosotros1', [$Texto[0] => $Banner], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="row justify-content-around justify-content-xl-center py-4 bg-gris">
            <div class="col-10 col-sm-6 col-md-4 col-xl-3">
                <div class="row justify-content-sm-center align-items-end wow fadeInDown">
                    <div class="col-4">
                        <img src="<?php echo e(asset('Imagenes/Nosotros/Iconos/IconoMision.svg')); ?>" alt="Icono de la Misión" class="img-fluid">
                    </div>
            ...
            <div class="col-10 col-sm-6 col-md-4 col-xl-3 my-5 my-sm-0 mx-xl-5">
                <div class="row justify-content-sm-center align-items-end wow fadeInDown">
                    <div class="col-4">
                        <img src="<?php echo e(asset('Imagenes/Nosotros/Iconos/IconoVision.svg')); ?>" alt="Icono de la Visión" class="img-fluid">
                    </div>
                    <div class="col-8 col-sm-7 col-lg-8 text-center">
            ...
            <div class="col-10 col-sm-6 col-md-4 col-xl-3 mt-sm-5 mt-md-0">
                <div class="row justify-content-sm-center align-items-end wow fadeInDown">
                    <div class="col-4">
                        <img src="<?php echo e(asset('Imagenes/Nosotros/Iconos/IconoFines.svg')); ?>" alt="Icono de los Fines" class="img-fluid">
                    </div>
                    <div class="col-8 col-sm-7 col-lg-8 text-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <?php $__currentLoopData = $FinesObjetivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Objetivos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="helvetica font-weight-normal text-blue">
                                    <?php echo e($Objetivos); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Pagina Maestra.PaginaMaestraPrincipal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoPVIT\ProyectoPVIT\resources\views/Nosotros.blade.php ENDPATH**/ ?>