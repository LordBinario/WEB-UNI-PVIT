...
<?php $__env->startSection('Contenido'); ?>
    <?php echo $__env->make('Vista parcial.Servicios1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="accordion pb-3" id="accordionExample">
                    <div class="card border border-secondary">
                            ...
                            <h2>
                                <div class="row justify-content-center mb-0 pb-0">
                                    <div class="col-9 text-center pt-2">
                                        <img src="<?php echo e(asset('Imagenes/Servicios/' . $IconoCurso1 . 'svg')); ?>" alt="Icono de curso 1" class="img-fluid">
                                        <h4 class="helvetica font-weight-bold text-blue"><?php echo e($NombreCurso1); ?></h4>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                        ...
                        <div id="CollapCursos1" class="collapse">
                            <div class="card-body">
                                <ul>
                                    <?php for($i = 0; $i < $TotalCurso1; $i++): ?>
                                        <li class="helvetica font-weight-normal text-blue"><?php echo e($Curso1[$i]); ?></li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card border border-secondary">
                        <a data-toggle="collapse" href="#CollapCursos2" role="button" aria-expanded="false" aria-controls="CollapCursos2">
                            <h2>
                                <div class="row justify-content-center mb-0 pb-0">
                                    <div class="col-9 text-center pt-2">
                                        <img src="<?php echo e(asset('Imagenes/Servicios/' . $IconoCurso2 . 'svg')); ?>" alt="Icono de curso 2" class="img-fluid">
                                        <h4 class="helvetica font-weight-bold text-blue"><?php echo e($NombreCurso2); ?></h4>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-2 col-sm-2 col-md-1 ml-1 w-100 bg-blue pt-1"></div>
                        ...
                        <div id="CollapCursos2" class="collapse">
                            <div class="card-body">
                                <ul>
                                    <?php for($i = 0; $i < $TotalCurso2; $i++): ?>
                                        <li class="helvetica font-weight-normal text-blue"><?php echo e($Curso2[$i]); ?></li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card border border-secondary">
                        <a data-toggle="collapse" href="#CollapCursos3" role="button" aria-expanded="false" aria-controls="CollapCursos3">
                            <h2>
                                <div class="row justify-content-center mb-0 pb-0">
                                    <div class="col-9 text-center pt-2">
                                        <img src="<?php echo e(asset('Imagenes/Servicios/' . $IconoCurso3 . 'svg')); ?>" alt="Icono de curso 3" class="img-fluid">
                                        <h4 class="helvetica font-weight-bold text-blue"><?php echo e($NombreCurso3); ?></h4>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-2 col-sm-2 col-md-1 ml-1 w-100 bg-blue pt-1"></div>
                        ...
                        <div id="CollapCursos3" class="collapse">
                            <div class="card-body">
                                <ul>
                                    <?php for($i = 0; $i < $TotalCurso3; $i++): ?>
                                        <li class="helvetica font-weight-normal text-blue"><?php echo e($Curso3[$i]); ?></li>
                                    <?php endfor; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <?php if($TotalCurso4 > 0): ?>
                        <div class="card border border-secondary">
                            <a data-toggle="collapse" href="#CollapCursos4" role="button" aria-expanded="false" aria-controls="CollapCursos4">
                                <h2>
                                    <div class="row justify-content-center mb-0 pb-0">
                                        <div class="col-9 text-center pt-2">
                                            <img src="<?php echo e(asset('Imagenes/Servicios/' . $IconoCurso4 . 'svg')); ?>" alt="Icono de curso 4" class="img-fluid">
                                            <h4 class="helvetica font-weight-bold text-blue"><?php echo e($NombreCurso4); ?></h4>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-2 col-sm-2 col-md-1 ml-1 w-100 bg-blue pt-1"></div>
                            ...
                            <div id="CollapCursos4" class="collapse">
                                <div class="card-body">
                                    <ul>
                                        <?php for($i = 0; $i < $TotalCurso4; $i++): ?>
                                            <li class="helvetica font-weight-normal text-blue"><?php echo e($Curso4[$i]); ?></li>
                                        <?php endfor; ?>
                                    </ul>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Pagina Maestra.PaginaMaestraPrincipal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoPVIT\ProyectoPVIT\resources\views/Servicios.blade.php ENDPATH**/ ?>